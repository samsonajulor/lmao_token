...
export interface LMAOTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface LMAOToken extends BaseContract {
  connect(runner?: ContractRunner | null): LMAOToken;
  waitForDeployment(): Promise<this>;

  interface: LMAOTokenInterface;
